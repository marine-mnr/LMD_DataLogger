...
/*attention il faut avoir fait "rtc.begin()" et "RTCZero rtc;" au pr�alable*/
...
/*Permet d'affecter la date et l'heure � une carte disposant d'une RTC */
...
/*Renvoie un timestamp, tableau de caract�res contenant la date et l'heure actuelle*/

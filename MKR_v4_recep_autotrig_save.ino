...
void read_and_save_trame_TSEN(){
  r=Serial1.read();
  //////////// TO_DO .......ce test ne fonctionne pas
  // long t_start=millis();
  // while (r!=TSEN_START){
  //    if (millis()-t_start>= 3000){     // timeout 3sec
  //      Serial1.flush();
  //     }
  //   }
   //////////// TO_DO .......ce test ne fonctionne pa
  if(r!=TSEN_STOP){
    ...
    if(debug){
      Serial.print(buffer);
      //Serial.print("coucoujutjutjttjytuyruyrururtuyruyruyruyruyruyruyruyrurur\n");
    }
  }
}
